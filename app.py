...
<Chain of Thought>
To provide comprehensive resume advice, I will first carefully analyze the given job description to identify the key skills, qualifications, and experience required for the role. Next, I will review the candidate's existing resume (only if provided else will not refer to the resume) and assess areas for improvement based on the job requirements. I will then suggest relevant skills, experiences, and accomplishments to highlight that align with the job description.
